"""
Telegram Notifier Module for Gold Event Finder (Clean Levels & Prices)
==============================================================================
...
from utils.env_settings import apply_telegram_secrets
...
def send_event_trigger_alert(event_dict: dict):
    ...
    from gold.xauusd_event_finder import _fmt_pct, event_settings
...
def schedule_30min_post_event_update():
    ...
    def _post_event_job():
        ...
        time.sleep(1800)
        try:
            from gold.xauusd_event_finder import (compute_gold_levels,
                                             fetch_latest_data)
