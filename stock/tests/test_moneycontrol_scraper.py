...
from stock.scrape_moneycontrol_stocks import build_manual_review_text, find_article_link_for_date, write_failure_outputs
...
class MoneycontrolScraperTests(unittest.TestCase):
    ...
    def test_ticker_mapping_aliases_and_exact_symbols(self) -> None:
        from stock.ticker_mapping import load_catalog, match_company_to_symbol
